...
AHierarchyActor::AHierarchyActor()
{
	...
	auto AutoMesh = ConstructorHelpers::FObjectFinder<UStaticMesh>(TEXT("StaticMesh'/Engine/BasicShapes/Cube.Cube'"));

	if(AutoMesh.Object != nullptr){
		BoxOne->SetStaticMesh(AutoMesh.Object);
		BoxTwo->SetStaticMesh(AutoMesh.Object);
	}
